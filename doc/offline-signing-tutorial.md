...
This workflow uses [Partially Signed Bitcoin Transactions](https://github.com/aixcoin/aixcoin/blob/master/doc/psbt.md) (PSBTs) to transfer the transaction to and from the offline wallet for signing using the private keys.
