...
```sh
cmake --build build --target aixd aix-cli
cmake --build build --target aix-qt
cmake --build build --target bench_aix
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:aix/aix.git
```
...
> e.g. github.com/aix/aix.git or for the GUI github.com/aix-core/gui
