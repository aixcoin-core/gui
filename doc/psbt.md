# PSBT Howto for Aix Core

Since Aix Core 0.17, an RPC interface exists for Partially Signed Aix
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/aix/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Aix transactions that are not fully signed
...
#### Multisig with multiple Aix Core instances
