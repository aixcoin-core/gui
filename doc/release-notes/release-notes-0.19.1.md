...
Aix Core version 0.19.1 is now available from:

  <https://aixcore.org/bin/aix-core-0.19.1/>
...
From Aix Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Aix Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Aix Core does not yet change appearance when
...
- #17488 fix "aixd already running" warnings on macOS (fanquake)
