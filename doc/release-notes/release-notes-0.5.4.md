Aix version 0.5.4 is now available for download at:
http://sourceforge.net/projects/aix/files/Aix/aix-0.5.4/
...
http://gitorious.org/aix/aixd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Aix-Qt notifications under Growl 1.3.
Increase required age of Aix-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAix properly when installing Aix-Qt over it. (Windows)
