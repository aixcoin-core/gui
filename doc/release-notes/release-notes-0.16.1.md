Aix Core version 0.16.1 is now available from:

  <https://aixcore.org/bin/aix-core-0.16.1/>
...
- #12843 `df38b13` Test starting aixd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure aixd processes are cleaned up when tests end (sdaftuar)
