Aix Core version 0.10.4 is now available from:

  <https://aix.org/bin/aix-core-0.10.4/>
...
- #6953 `43c2789` Split aix-tx into its own package
- #6953 `dfe0d4d` Include aix-tx binary on Debian/Ubuntu
