Aix Core version 0.9.4 is now available from:

  https://aix.org/bin/0.9.4/
...
this update is incompatible with the Aix system and could lead to consensus
forks.

Aix Core released binaries from https://aix.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~aix/+archive/ubuntu/aix
- A third-party or self-compiled Aix Core

upgrade to Aix Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
