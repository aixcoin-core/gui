Aix Core version 0.13.2 is now available from:

  <https://aix.org/bin/aix-core-0.13.2/>
...
- #8908 `4a974b2` Update aix-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow aix-tx to create v2 transactions (btcdrak)
