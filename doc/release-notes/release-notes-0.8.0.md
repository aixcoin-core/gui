Aix-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/aix/files/Aix/aix-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Aix
...
New/changed settings (command-line or aix.conf file)
--------------------------------------------------------
