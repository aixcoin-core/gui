...
- bitcoin-core/gui#21 Improve pruning tooltip (fluffypony, AixErrorLog)
...
- bitcoin/bitcoin#20577 libconsensus: add missing error code description, fix NAix link (theStack)
