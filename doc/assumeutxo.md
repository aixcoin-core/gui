...
Assumeutxo is a feature that allows fast bootstrapping of a validating aixd
instance.
...
```
$ aix-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ aix-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
