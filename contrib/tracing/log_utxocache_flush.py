...
"""Example logging Aix Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py <pid of aixd>
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[aixd_with_usdts])
