...
declare -A LIBS
LIBS[cli]="libaix_cli.a"
LIBS[common]="libaix_common.a"
LIBS[consensus]="libaix_consensus.a"
LIBS[crypto]="libaix_crypto.a"
LIBS[node]="libaix_node.a"
LIBS[util]="libaix_util.a"
LIBS[wallet]="libaix_wallet.a"
...
# https://github.com/aix/aix/issues/10102
