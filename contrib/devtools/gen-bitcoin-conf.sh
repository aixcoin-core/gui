...
BITCOIND=${BITCOIND:-$BINDIR/aixd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/aix.conf}
...
then
  ...
  echo -e "To safely generate a aix.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example aix.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-aix-conf.sh.
##
...
# parse the output from aixd --help
