...
complete --command aixd --no-files

# Extract options
function __fish_aixd_get_options
...
complete \
    --command aixd \
    --arguments "(__fish_aixd_get_options --nofiles)"
