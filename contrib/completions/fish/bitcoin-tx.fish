...
# Extract options
function __fish_aix_tx_get_options
...
# Extract commands
function __fish_aix_tx_get_commands
...
complete \
    --command aix-tx \
    --condition "not __fish_aix_seen_cmd (__fish_aix_tx_get_commands --commandsonly)" \
    --arguments "(__fish_aix_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command aix-tx \
    --arguments "(__fish_aix_tx_get_commands)" \
    --no-files
