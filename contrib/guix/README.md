# Bootstrappable Aix Core Builds

This directory contains the files necessary to perform bootstrappable Aix
Core builds.
...
To build Aix Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/aix-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/aix-core/guix.sigs).
