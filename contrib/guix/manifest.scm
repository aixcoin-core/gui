...
(define* (make-aix-cross-toolchain target
                                       #:key
...
desirable for building Aix Core release binaries."
...
;; failure; see https://github.com/aix/aix/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-aix-cross-toolchain target)))
