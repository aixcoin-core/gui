...
{
    // Test regression https://github.com/aix/aix/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/aix-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/aix-core/gui/pull/568.
    // With fListen=false in ~/.config/Aix/Aix-Qt.conf and all else left as default,
    // aix-qt should set both -listen and -listenonion to false and start successfully.
