...
//! Entry point for AixApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AixApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AixGUI tests.
void AppTests::guiTests(AixGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AixGUI::consoleShown, this, &AppTests::consoleTests);
