...
/** Main Aix application object */
class AixApplication: public QApplication
{
    Q_OBJECT
public:
    explicit AixApplication();
    ~AixApplication();
    ...
    /// Get window identifier of QMainWindow (AixGUI)
...
Q_SIGNALS:
    ...
    void windowShown(AixGUI* window);
