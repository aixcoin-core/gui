...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, AixUnits::SeparatorStyle separators=AixUnits::SeparatorStyle::STANDARD) const;
