...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = AixUnits::formatWithUnit(unit, amount, true, AixUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
...
{
    AixUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(AixUnits::formatWithPrivacy(unit, balances.balance, AixUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(AixUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, AixUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(AixUnits::formatWithPrivacy(unit, balances.immature_balance, AixUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(AixUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, AixUnits::SeparatorStyle::ALWAYS, m_privacy));
