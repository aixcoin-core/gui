      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->aixAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->aixAtStartup);
    ...
    ui->aixAtStartup->setToolTip(ui->aixAtStartup->toolTip().arg(CLIENT_NAME));
    ui->aixAtStartup->setText(ui->aixAtStartup->text().arg(CLIENT_NAME));

    ui->openAixConfButton->setToolTip(ui->openAixConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new AixUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->aixAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAixConfButton_clicked()
{
