...
void IpcSocketTest(const fs::path& datadir)
{
    ...
    //   Address 'unix' path '"/tmp/test_common_Aix Core/ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff/test_bitcoin.sock"' exceeded maximum socket path length
