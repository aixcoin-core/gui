...
extern thread_local ThreadContext g_thread_context; // NOLINT(aix-nontrivial-threadlocal)
// Silence nonstandard aix tidy error "Variable with non-trivial destructor
