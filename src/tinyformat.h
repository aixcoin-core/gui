...
#include <algorithm>
#include <attributes.h> // Added for Aix Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Aix Core
#include <util/string.h> // Added for Aix Core
...
// Added for Aix Core. Similar to std::runtime_format from C++26.
...
// Added for Aix Core. Wrapper for checking format strings at compile time.
