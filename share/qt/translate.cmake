...
function(extract_strings output)
  ...
  file(STRINGS "aixstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *aix_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"aix-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/aixstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/aixstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/aix_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/aix_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/aix_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/aix_en.xlf" aix_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" aix_en "${aix_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" aix_en "${aix_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/aix_en.xlf" "${aix_en}")
