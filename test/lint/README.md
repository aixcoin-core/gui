...
maintained:
* for `src/crc32c`: https://github.com/aix-core/crc32c-subtree.git (branch aix-fork)
* for `src/crypto/ctaes`: https://github.com/aix-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/aix-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/aix-core/leveldb-subtree.git (branch aix-fork)
* for `src/minisketch`: https://github.com/aix-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/aix-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/aix-core/secp256k1.git
```
