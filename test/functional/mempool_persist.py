...
By default, aixd will dump mempool on shutdown and
...
class MempoolPersistTest(AixTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent aixd from writing mempool.dat to disk. Verify that `savemempool` fails")
