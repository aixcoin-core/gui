...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The aixd node closes feeler connections as soon as a version
...
class P2PAddConnections(AixTestFramework):
    ...
    def run_test(self):
        ...
        # aixd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that aixd sends its own version prior to processing
