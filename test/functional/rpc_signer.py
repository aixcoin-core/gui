...
Verify that a aixd node can use an external signer command.
...
class RPCSignerTest(AixTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart aixd with -signer=<cmd>',
