#!/usr/bin/env python3
# Copyright (c) 2016-present The Aix Core developers
...
# TestP2PConn: A peer we use to send messages to aixd, and store responses.
...
class CompactBlocksTest(AixTestFramework):
    ...
    # This test actually causes aixd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that aixd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for aixd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # aixd will not send blocktxn responses for blocks whose height is
