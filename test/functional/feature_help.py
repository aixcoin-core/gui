...
"""Verify that starting aix with -h works as expected."""

from test_framework.test_framework import AixTestFramework
from test_framework.util import assert_equal

class HelpTest(AixTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aix with -h for help text")
        ...
        self.log.info("Start aix with -version for version information")
        ...
        self.log.info("Start aixd with -fakearg to make sure it does not start")
