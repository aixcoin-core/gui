...
class TestShell:
    """Wrapper Class for AixTestFramework.

    The TestShell class extends the AixTestFramework
    ...
    class __TestShell(AixTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AixTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # AixTestFramework instances are supposed to be constructed with the path
