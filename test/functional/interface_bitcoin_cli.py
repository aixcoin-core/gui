...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"aix-cli -h\" for help or \"aix-cli listwallets\" to see "
...
class TestAixCli(AixTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `aix-cli getblockchaininfo`")
        ...
        # Prevent aix-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and aix-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and aix-cli getwalletinfo return expected wallet info")
            ...
            # Test aix-cli -generate with -rpcwallet in multiwallet mode.
