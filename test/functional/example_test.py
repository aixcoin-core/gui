...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AixTestFramework
    pass


class ExampleTest(AixTestFramework):
    # Each functional test is a subclass of the AixTestFramework class.
    ...
    def custom_method(self):
        ...
        AixTestFramework class so other tests can use it."""
