...
class FullBlockTest(AixTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure aixd isn't accepting b26
        ...
        # Extend the b28 chain to make sure aixd isn't accepting b28
        ...
        # aixd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the aix code has custom code which does so);
