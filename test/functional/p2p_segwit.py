...
class SegWitTest(AixTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older aixd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let aixd fill it in.
