...
Aix Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Aix Core

**When configuring Aix Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Aix Core:
...
variables will be set when generating the Aix Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
